              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 mb-4">Selamat Datang Di Aplikasi Pengaduan Login Admin/Petugas!</h1>
                  </div>
                  <form class="user" method="post" action="proses-login2.php">
                    ...
                    <hr>
                    <a href="index.php" class="btn btn-succes btn-user btn-block" style="font-weight: normal;">
