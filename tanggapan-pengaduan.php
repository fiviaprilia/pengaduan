...
// Mengambil data pengaduan dengan status 'proses' (untuk petugas)
...
<head>
    ...
    <title>Tanggapan Pengaduan - Petugas</title>
...
<body>
    <div class="container mt-4">
        <h1>Tanggapan Pengaduan - Petugas</h1>
        <table class="table table-bordered">
            ...
            <tbody>
                <?php if (mysqli_num_rows($result) > 0): ?>
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        <tr>
                            ...
                            <td>
                                <a href="proses-tanggapan.php?id_pengaduan=<?= $row['id_pengaduan']; ?>" 
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="6">Tidak ada pengaduan yang sedang diproses.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
